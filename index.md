...
* Mar'23: I am happy to take the role of the tutorial chair for CP'23.
* Feb'23: Two of our papers written with Matthias Horn and Neil Yorke-Smith have been accepted to ICAPS'23! More info will follow.
...
* Recent publications (see my [Google Scholar](https://scholar.google.com/citations?hl=en&user=QUhD6A0AAAAJ&view_op=list_works&sortby=pubdate) for full list): 
	- [Fair and Optimal Decision Trees: A Dynamic Programming Approach](https://openreview.net/forum?id=LCIZmSw1DuE) (NeurIPS'22)
	...
	- [Talking Trucks: Decentralized Collaborative Multi-Agent Order Scheduling for Self-Organizing Logistics](https://ojs.aaai.org/index.php/ICAPS/article/view/19834) (ICAPS'22)
	- [Modelling Zeros in Blockmodelling](https://link.springer.com/chapter/10.1007/978-3-031-05936-0_15) (PAKDD'22)
...
## Algorithms for optimal decision trees (2021-2026)
* Funding: TU Delft, 300k€ (principal investigator)
* Project staff: Koos van der Linden (PhD)
* Co-supervision with Professor Mathijs de Weerdt

## Unifying SAT, constraint programming, and pseudo-Boolean solving (2022-2026)
* Funding: NWO M1, 350k€ (principal investigator)
* Project staff: Maarten Flippo (PhD)

## Explainable AI Lab (2022-2027)
* Funding: Delft AI Labs, 1m€ (500k€ as principal investigator)
* Explainable combinatorial optimisation
	* Project staff: Konstantin Sidorov (PhD)
	* Co-supervision with Professor Mathijs de Weerdt and Dr. Gonçalo Correia
* Explainable algorithms for ride-sharing recommender systems
	* Project staff: Elif Arslan (PhD)
	* Co-supervision with Dr. Marco Rinaldi, Professor Oded Cats, Professor Serge Hoogendoorn

## Scheduling Algorithms for Quantum Computing (2023-2027)
* Funding: part of a NWO Zwaartekracht (Quantum Software Consortium), 300k€ (principal investigator)
* Project staff: open position (PhD)
* Co-supervision with Dr. Menno Veldhorst

## Algorithms for industrial scheduling (2021-2022)
* Funding: VoestAlpine (industry) and TU Delft, 100k€ (principal investigator)
* Project staff: Dr. Matthias Horn (Postdoc)
* Co-supervision with Dr. Neil Yorke-Smith (PI)

# Core research team

* Koos van der Linden (PhD), Algorithms for optimal decision trees
* Maarten Flippo (PhD), Unifying SAT, constraint programming, and pseudo-Boolean solving
* Elif Arslan (PhD), Explainable algorithms for ride-sharing recommender systems
* Konstantin Sidorov (PhD), Explainable combinatorial optimisation
* To be filled (PhD), Scheduling algorithms for quantum computing

## Former members

* Dr Matthias Horn (Postdoc), Algorithms for industrial scheduling
